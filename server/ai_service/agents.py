...
# import uuid
# from .autogen_studio_integration import AutoGenEmailAnalysis
...
#         self.autogen_analysis = None
#         try:
#             config_list = [{
#                 "model": "microsoft/phi-4-reasoning-plus:free",
#                 "api_key": "your-api-key-here"  # Replace with your actual API key
#             }]
#             self.autogen_analysis = AutoGenEmailAnalysis(config_list)
#         except Exception as e:
#             logger.warning(f"Failed to initialize AutoGen Studio: {str(e)}")
#             self.autogen_analysis = None
...
#     def analyze_email_with_autogen(self, email_data: Dict[str, str]) -> Dict[str, Any]:
#         """
#         Analyze an email using AutoGen Studio's multi-agent system.
...
#         """
#         if not self.autogen_analysis:
#             logger.warning("AutoGen Studio not initialized, falling back to standard analysis")
#             return self.analyze_email(email_data)
            
#         try:
#             # Use AutoGen Studio for analysis
#             autogen_results = self.autogen_analysis.analyze_email(email_data)
            
#             if autogen_results["status"] == "success":
#                 # Create a chat ID for tracking
#                 chat_id = str(uuid.uuid4())
...
#                     "email_content": email_data.get('content', ''),
#                     "email_sender": email_data.get('sender', ''),
#                     "current_category": "autogen",
#                     "categories": ["metadata", "content", "risk"],
#                     "category_index": 0,
#                     "autogen_analysis": autogen_results,
#                     "current_question_index": 0
#                 }
                
#                 # Format the first question based on metadata analysis
#                 first_question = self._format_autogen_question(autogen_results["metadata_analysis"])
...
#                 }
#             else:
#                 logger.warning("AutoGen analysis failed, falling back to standard analysis")
#                 return self.analyze_email(email_data)
                
#         except Exception as e:
#             logger.error(f"Error in AutoGen email analysis: {str(e)}")
#             return self.analyze_email(email_data)
    
#     def _format_autogen_question(self, analysis: str) -> str:
#         """
#         Format the AutoGen analysis into a question format compatible with the existing system.
        
#         Args:
#             analysis: The analysis text from AutoGen
            
#         Returns:
#             Formatted question string
#         """
#         # Extract the first key point from the analysis
#         lines = analysis.split('\n')
#         for line in lines:
#             if line.strip() and not line.startswith(('1.', '2.', '3.')):
#                 return f"🔎 {line.strip()}\n\n❓ Based on this analysis, what specific aspects concern you the most?"
        
#         return "🔎 Initial analysis complete.\n\n❓ What aspects of this email would you like to discuss further?"
